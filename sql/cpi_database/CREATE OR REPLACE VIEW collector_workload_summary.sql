...
JOIN app_user u 
    ON ca.collector_id = u.user_id
JOIN dim_outlet o 
    ON ca.outlet_id = o.outlet_id
JOIN dim_island i 
    ON o.island_id = i.island_id
...
-- Large outlet item assignments
SELECT
    cia.assignment_id AS summary_id,
    i.island_name,
    o.outlet_name,
    total.total_items,
    ...
    cia.is_active AS is_active,
    MIN(cia.assigned_at) AS assigned_date

FROM collector_item_assignment cia
JOIN app_user u
    ON cia.collector_id = u.user_id
JOIN cpi_collection_item ci
    ON cia.collection_item_id = ci.collection_item_id
JOIN dim_outlet o
    ON ci.outlet_id = o.outlet_id
JOIN dim_island i
    ON o.island_id = i.island_id
JOIN (
    ...
    ON total.outlet_id = o.outlet_id
